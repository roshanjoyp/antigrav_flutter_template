...
/// Dev-only screen running the manifest's runtime setup checks.
///
/// The runtime sibling of `tool/doctor.dart`: verifies what static
/// analysis can't — Firebase initializes, anonymous auth round-trips,
/// an FCM token is issued — and lists the manual console steps per
/// module. Only routed in debug builds; release builds exclude it.
